...
$page_title = "Object Oriented Metrics";
...
$page_nav["sm"]["sub"]["oo"]["active"] = true;
include("inc/nav.php");
?>
...
<?php
    ...
    <div id="content">
        <div class="row">
			...
			<h1 class="page-title txt-color-blueDark"><img src="<?php echo ASSETS_URL; ?>/img/SCQAP.png" width="50px" height="50px" alt="SCAP">&nbsp SCQAP - Object Oriented Metrics </h1>
            </div>
...
<?php echo join(', ', $_SESSION["cbo"]); ?>
            ...
            <div class="well well-sm well-light padding-10">
								<h4 class="txt-color-green">Deployment GAS vs <span class="semi-bold">CBO</span> <a href="javascript:void(0);" class="pull-right txt-color-green"><i class="fa fa-refresh"></i></a></h4>  
                <div class="sparkline" 
                    ...
                    data-sparkline-bar-val="[<?php echo join(', ', $_SESSION["cbo"]); ?>]">
				</div> 	
        </div>
            </article>
    </div>    					
